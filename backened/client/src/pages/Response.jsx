...
function Response() {
    ...
    const [no_Response, setno_Response] = useState(false);
    ...
    const fetchFormById = async () => {
        ...
        setFormData(data);
        if (data.formResponse.length == 0) setno_Response(true);
    };
    ...
    return (
        <div className={styles.response}>
            <Navbar />
            {no_Response && <p className={styles.no_Response}>No response yet collected</p>}
